...
updateData <- function(outputFile, pyhtonExePath = NULL, condaenv = T){

reticulate::use_python("C:\\Users\\tsimonat\\AppData\\Local\\Programs\\Python\\Python312\\python.exe")
# or 
# reticulate::use_condaenv()
reticulate::py_config()
# edit environment variables
Sys.setenv(PYTHON = "C:\\Users\\tsimonat\\AppData\\Local\\Programs\\Python\\Python312\\python.exe")

pyam <- reticulate::import("pyam")

df_py <- pyam$read_iiasa("ssp")

iiasa_raw <- list(
  index = df_py$index,            # Índices do IamDataFrame
  data = df_py$data,              # Dados da série temporal
  meta = df_py$meta,              # Metadados
  region = df_py$region,          # Regiões
  variable = df_py$variable,      # Variáveis
  unit = df_py$unit,              # Unidades
  year = df_py$year               # Anos
)

# Save the data frame as an .rda file
save(iiasa_raw, outputFile = "data/iiasa_raw.rda", compress = "xz")
...
gtapssp::updateData(pythonExePath = "C:\\Users\\tsimonat\\AppData\\Local\\Programs\\Python\\Python312\\python.exe", outputFile = "data/iiasa_raw.rda")
...
# read corresp_reg.csv in data folder
...
gtapssp::updateCorresp(iiasa_raw = gtapssp::iiasa_raw,
                          corresp_reg = gtapssp::corresp_reg)

save(corresp_reg, file = "data\\corresp_reg.rda")

# read the data saved above
load("data\\corresp_reg.rda")
...
# 
# 
# cty_mappings <- gtapssp::txtToData("data\\gtp10_10.agg")$`Section 4`
# 
