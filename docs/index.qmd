...
#| eval: true
#| include: false
DT::datatable(ssp_data[1:40,], height = 300, options = list(
                scrollX = TRUE,
                scrollY = "250px",
                scrollCollapse = TRUE
              ))
...
gtapssp::iiasa_gtap(outFile = "gtap_ssp2.har")
...
Below is a spatial representation of the population data. The map below highlights population estimates for females (GND == "FEML"), aged 65 and above (AGE == "P65UP") in the year 1950 (YRS == "Y1950"), under the SSP1 scenario (SCE == "SSP1"). The data is sourced from the IIASA-WiC POP 2023 dataset (MOD == "IIASA-WiC POP 2023").
...
Below is a spatial representation of GDP per capita projections. The map below shows GDP per capita in PPP (2017 USD) for the year 2100 (YRS == "Y2100") under the SSP1 scenario. The data comes from the OECD ENV-Growth 2023 dataset.
